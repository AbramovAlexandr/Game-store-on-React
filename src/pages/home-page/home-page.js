...
import {GameItem} from '../../componets/game-item';
...
const GAMES = [
    ...
    {
        image: '/img/horse3.jpeg',
        title: 'Черно-Белая Лошадь',
        genres: [' ', '  ', ' '],
        video: 'https://www.youtube.com/embed/ssrNcwxALS4',
        price: 3000,
        id: 7,
...
export const HomePage = () => {
    return(
        <div className="home-page">
                {GAMES.map(game => <GameItem  game={game}  key="game.id"></GameItem>)}
        </div>
    )
}